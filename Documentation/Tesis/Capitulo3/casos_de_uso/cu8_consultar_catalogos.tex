\subsection{Caso de uso 8: Consultar catálogo} \label{cu8}
...
\begin{enumerate}
  ...
  \item {\includegraphics[scale=.05]{Capitulo3/img/proceso.png} Se muestra las opciones: Modificar vehículos y Modificar dispositivos}
  \textit{Fin de caso de uso} \\  
\end{enumerate}
