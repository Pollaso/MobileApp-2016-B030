\subsection{Caso de uso 7.1: Modificar vehículos} \label{cu}
...
\begin{center}
  \captionof{table}{Caso de uso 7.1: Modificar vehículos} \label{tab:cu7_tab}
...
\begin{enumerate}
  ...
  \item {\includegraphics[scale=.05]{Capitulo3/img/proceso.png} Se muestra la IU vehículo_datos
